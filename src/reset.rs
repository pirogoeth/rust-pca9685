...
/// Writes a SOFT_RESET directly to the I2C master and switches the device back to the PCA9685 slave.
pub fn soft_reset(dev: &mut LinuxI2CDevice, slave_addr: Option<u16>) -> Result<(), LinuxI2CError> {
